      ...
      {language === "english" && (
        <section id="about" className="section-about">
          ...
          <p className="about-text">
            ...
            some basics and at the moment dwelling into the world of React.
            {/* In
      ...
      {language === "spanish" && (
        <section id="about" className="section-about">
          ...
          <p className="about-text">
            ...
            de React.
            {/* En esta página encontrarás un par de cosas que estoy
      ...
      {language === "german" && (
        <section id="about" className="section-about">
          ...
          <p className="about-text">
            ...
            Moment trete ich in die Welt von React.
